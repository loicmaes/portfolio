...
import IconChevronUp from "~/components/uikit/icons/arrows/IconChevronUp.vue";
  ...
  <div class="accordion">
    ...
    <div class="accordion--wrapper" :class="{ deployed }">
      <div class="accordion--wrapper-content">
        ...
        <span class="accordion--foot"><slot name="foot" /></span>
      </div>
    </div>
  </div>
</template>
...
.accordion
  ...
  &--head
    @apply flex justify-between items-center px-8 py-6 font-bold
  ...
  &--content
    @apply mx-8 text-woodsmoke-400 whitespace-pre-line

  &--foot
    @apply text-woodsmoke-200 dark:text-woodsmoke-800 mr-8 self-end mb-6
</style>
